...
The following grid was generated by the EMA model after **150 epochs** of training on CIFAR-10:

<p align="center">
  <img src="results/final.png" alt="Generated CIFAR-10 Samples" width="512">
</p>

Each row corresponds to one CIFAR-10 class in order:
...
Below is a visualization of the denoising process during reverse diffusion  
(snapshot saved every 50 steps from **t = 1000 → 0**):

<p align="center">
  <img src="results/diffusion_steps.png" alt="Reverse Diffusion Process" width="700">
</p>

This shows how the model gradually denoises pure Gaussian noise into a clean image.
